...
class IntegrationTest extends SentryLaravelTestCase
{
    ...
    {
        $route = (new Route('GET', '/foo', null))->name($routeName = 'foo-bar');
    ...
    {
        $route = new Route('GET', $url = '/foo', null);
    ...
    public function testExtractingNameForRouteWithAutoGeneratedName(): void
    {
        ...
        $route = (new Route('GET', $url = '/foo', null))->name('generated::KoAePbpBofo01ey4');
    ...
    {
        $route = (new Route('GET', $url = '/foo', null))->name('group-name.');
