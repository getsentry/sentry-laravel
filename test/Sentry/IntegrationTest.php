...
class IntegrationTest extends SentryLaravelTestCase
{
    ...
    public function testExtractingNameForRouteWithRealName(): void
    {
        $route = new Route('GET', '/foo', static function (): void {
            // do nothing...
        });
        $route->name('foo-bar');

        $this->assertSame('foo-bar', Integration::extractNameForRoute($route));
    }
    ...
    public function testExtractingNameForRouteWithAutoGeneratedName(): void
    {
        ...
        $route->name('generated::KoAePbpBofo01ey4');

        $this->assertSame('/foo', Integration::extractNameForRoute($route));
    }

    public function testExtractingNameForClosureRouteWithoutName(): void
    {
        $route = new Route('GET', '/foo', static function (): void {
            // do nothing...
        });
