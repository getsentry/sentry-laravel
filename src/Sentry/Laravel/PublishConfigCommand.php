...
class PublishConfigCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'sentry:publish {--dsn=} {--enable-performance-monitoring} {--without-test}';
    ...
    public function handle()
    {
        ...
        if ($this->confirm('Enable Performance Monitoring?', $this->option('enable-performance-monitoring'))) {
