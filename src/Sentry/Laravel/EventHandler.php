...
class EventHandler
{
     ...
     * @var bool
     */
    protected $recordOctaneTickInfo;
     ...
     * @var bool
     */
    protected $recordOctaneTaskInfo;
     ...
     * @var int
     */
    protected $pushedQueueScopeCount = 0;
     ...
     * @var bool
     */
    protected $pushedOctaneScope = false;
    ...
    protected function prepareScopeForOctane(): void
    {
        $this->cleanupScopeForOctane();
    ...
    protected function cleanupScopeForOctane(): void
    {
     ...
     */
    protected function afterTaskWithinLongRunningProcess(): void
    {
        // Flush any and all events that were possibly generated by queue jobs
        Integration::flushEvents();
    }
     ...
     */
    protected function prepareScopeForTaskWithinLongRunningProcess(): void
    {
     ...
     */
    protected function cleanupScopeForTaskWithinLongRunningProcessWhen(bool $when): void
    {
        if (!$when) {
            return;
        }
