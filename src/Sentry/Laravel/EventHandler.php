...
class EventHandler
{
    ...
    protected static $queueEventHandlerMap = [
        ...
        'Illuminate\Queue\Events\JobExceptionOccurred' => 'queueJobProcessed', // Since Laravel 5.2
    ];
     ...
     * Since Laravel 5.2.
     *
     * @param \Illuminate\Queue\Events\JobProcessed|\Illuminate\Queue\Events\JobExceptionOccurred $event
     */
    protected function queueJobProcessedHandler($event)
    {
